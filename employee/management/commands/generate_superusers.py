...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        for i in range(count):
            ...
            if superuser:
                User.objects.create_superuser(username=username, email='admin@gmail.com', password='123')
            else:
                User.objects.create_user(username=username, email='admin@gmail.com', password='123')